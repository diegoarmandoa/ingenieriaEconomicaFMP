...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-11-2022 a las 00:37:11
...
(1, 1, 'Hugo Aguirre', 65446543, 'San Vicente - El Salvador', 9);
...
INSERT INTO `configuracion` (`id`, `dni`, `nombre`, `telefono`, `email`, `direccion`, `igv`) VALUES
(1, 1010, 'Tiendita Snack', 76764345, 'tienditasnack@ues.ued.sv', 'San Vicente, El Salvador', '0.13');
...
(1, '2022-11-29 17:31:50', 9, 1, '1.35', 1),
(2, '2022-11-29 17:35:11', 9, 1, '0.15', 1);
...
(1, 'Jalapeño', 2, '0.15', 27, 9),
(2, 'Nachos', 2, '0.15', 28, 9),
(3, 'Coca-Cola', 1, '0.75', 47, 9);
...
INSERT INTO `proveedor` (`codproveedor`, `proveedor`, `contacto`, `direccion`, `usuario_id`) VALUES
(1, 'Industria la Constancia', '7656-5445', 'San Salvador, El Salvador', 9),
(2, 'Boquitas DIANA', '7654-3222', 'San Salvador - El Salvador', 9);
...
(9, 'Enrique Dominguez', 'Admin', '21232f297a57a5a743894a0e4a801fc3', 1);
...
--
ALTER TABLE `detallefactura`
  MODIFY `correlativo` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `factura`
  MODIFY `nofactura` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
