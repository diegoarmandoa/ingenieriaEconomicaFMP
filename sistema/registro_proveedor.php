...
if (!empty($_POST)) {
    $alert = "";
    if (empty($_POST['proveedor']) || empty($_POST['contacto']) ||  empty($_POST['direccion'])) {
        ...
        $query_insert = mysqli_query($conexion, "INSERT INTO proveedor(proveedor,contacto,direccion,usuario_id) values ('$proveedor', '$contacto', '$Direccion','$usuario_id')");
        if ($query_insert) {
            ...
            <div class="card">
                <form action="" autocomplete="off" method="post" class="card-body p-2">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Ingrese teléfono" name="contacto" id="contacto" class="form-control">
                    </div>
                    <div class="form-group">
