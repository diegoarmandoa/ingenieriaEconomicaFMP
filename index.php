...
if (!empty($_SESSION['active'])) {
  ...
  Ingrese su usuario y su clave
      ...
      $query = mysqli_query($conexion, "SELECT u.idusuario, u.nombre,u.usuario,r.idrol,r.rol FROM usuario u INNER JOIN rol r ON u.rol = r.idrol WHERE u.usuario = '$user' AND u.clave = '$clave'");
...
<head>
  ...
  <title>Sistema Informatico IEC175</title>
